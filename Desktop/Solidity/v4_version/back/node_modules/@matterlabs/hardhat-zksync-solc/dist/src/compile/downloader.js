...
class ZksolcCompilerDownloader {
    ...
    static async _downloadCompilerVersionInfo(compilersDir) {
        ...
        await (0, utils_1.download)(url, downloadPath, 'hardhat-zksync', 'compiler-version-info', 30000);
    }
    ...
    async _attemptDownload(url, downloadPath) {
        return (0, utils_1.download)(url, downloadPath, 'hardhat-zksync', this._version, 30000);
    }
