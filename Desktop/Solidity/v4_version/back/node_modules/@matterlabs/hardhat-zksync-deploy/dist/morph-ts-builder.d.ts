...
export declare class MorphTsBuilder {
    ...
    intialStep(steps: (MorphBuilderInitialStepType | MorphBuilderInitialStepVariable | MorphBuilderInitialStepModule)[]): MorphTs;
}
export declare class MorphTs {
    ...
    constructor(_steps: (MorphBuilderInitialStepType | MorphBuilderInitialStepVariable | MorphBuilderInitialStepModule)[], _sourceFile: SourceFile, _filePath: string);
