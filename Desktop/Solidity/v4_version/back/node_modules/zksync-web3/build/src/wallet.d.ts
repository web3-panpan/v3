import { EIP712Signer } from 'zksync-web3/build/src/signer';
import { Provider } from 'zksync-web3/build/src/provider';
import { ethers, utils } from 'ethers';
import { BlockTag, TransactionResponse, TransactionRequest } from 'zksync-web3/build/src/types';
...
declare const Wallet_base: {
    new (...args: any[]): {
        ...
        getAllBalances(): Promise<import("zksync-web3/build/src/types").BalancesMap>;
        getL2BridgeContracts(): Promise<{
            erc20: import("zksync-web3/build/typechain").IL2Bridge;
        }>;
        _fillCustomData(data: import("zksync-web3/build/src/types").Eip712Meta): import("zksync-web3/build/src/types").Eip712Meta;
    ...
    new (...args: any[]): {
        ...
        getMainContract(): Promise<import("zksync-web3/build/typechain").IZkSync>;
        getL1BridgeContracts(): Promise<{
            erc20: import("zksync-web3/build/typechain").IL1Bridge;
        }>;
        ...
        }): Promise<import("zksync-web3/build/src/types").PriorityOpResponse>;
        ...
        _getWithdrawalLog(withdrawalHash: ethers.utils.BytesLike, index?: number): Promise<{
            log: import("zksync-web3/build/src/types").Log;
            l1BatchTxId: number;
        }>;
        _getWithdrawalL2ToL1Log(withdrawalHash: ethers.utils.BytesLike, index?: number): Promise<{
            l2ToL1LogIndex: number;
            l2ToL1Log: import("zksync-web3/build/src/types").L2ToL1Log;
        }>;
