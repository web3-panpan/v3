...
import { Address, EventFilter, BlockTag, TransactionResponse, TransactionRequest, TransactionStatus, Token, PriorityOpResponse, BalancesMap, MessageProof, TransactionReceipt, Block, BlockWithTransactions, Log, TransactionDetails, BlockDetails, ContractAccountInfo } from 'zksync-web3/build/src/types';
import { Signer } from 'zksync-web3/build/src/signer';
